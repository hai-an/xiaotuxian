<template>
  ...
  <div class="g-service">
    ...
    <dl>
      <dt>配送</dt>
      <dd>至 <xtx-city @change="changeCity" :fullLocation="fullLocation" /> </dd>
    </dl>
    <dl>
      <dt>服务</dt>
      <dd>
...
export default {
  ...
  setup (props, { emit }) {
    ...
    // 已登录 有默认地址 userAddresses[index].isDefault === 1
    if (props.goods.userAddresses) {
      ...
      if (defaultAddr) {
        ...
        fullLocation.value = defaultAddr.fullLocfullLocationation
      }
    }
    // 选择城市
