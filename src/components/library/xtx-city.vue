<template>
  <div class="xtx-city" ref="target">
    <div class="select" :class="{active:show}">
      <span v-if="!fullLocation" @click="toggle" class="placeholder">请选择配送地址</span>
      <span v-else  @click="toggle" class="value">{{fullLocation}}</span>
